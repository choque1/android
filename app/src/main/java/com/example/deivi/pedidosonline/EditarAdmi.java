...
public class EditarAdmi extends AppCompatActivity {
    ...
    private void loadData() {
        ...
        client.get("http://192.168.1.108:7777/api/v1.0/cliente", null, new JsonHttpResponseHandler() {
            @Override
    ...
    public void sedData(){
        ...
        TextView ci  = findViewById(R.id.ci4);
        TextView telefono = findViewById(R.id.phone4);
        TextView email  = findViewById(R.id.correo4);
        ...
        client .patch(Data.REGISTER_CLIENTE, params, new JsonHttpResponseHandler() {
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                ...
                try {
                    ...
                    if(resp==200){
                        ...
                        final String ci_resp=json.getString("ci");
                        final String telefono_resp=json.getString("telefono");
                        ...
                        alertDialog.setButton(AlertDialog.BUTTON_NEUTRAL, "OK", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                intent.putExtra("ci",ci_resp);
                                intent.putExtra("telefono",telefono_resp);
